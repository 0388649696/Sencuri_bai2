# ==========================================
# tao_khoa.py - Tạo cặp khóa RSA + chứng chỉ tự ký (self-signed)
...
subject = issuer = x509.Name([
    ...
    x509.NameAttribute(NameOID.STATE_OR_PROVINCE_NAME, "Bac Ninh"),
    x509.NameAttribute(NameOID.LOCALITY_NAME, "Bac Ninh"),
    x509.NameAttribute(NameOID.ORGANIZATION_NAME, "K58KTP"),
    x509.NameAttribute(NameOID.COMMON_NAME, "Nguyen Duc Anh Tu"),
])
